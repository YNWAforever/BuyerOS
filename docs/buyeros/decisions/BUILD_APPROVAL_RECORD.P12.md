...
| Allowed files | create `services/api/buyeros_api/api/schemas.py`, `services/api/buyeros_api/api/idempotency.py`, `services/api/alembic/versions/0009_project_profile_columns.py`, `services/api/tests/test_api_projects_db.py`, `services/live/profile.ts`, `services/live/writes.ts`, `features/live/{offer-wizard,profile}.tsx`; modify `services/api/buyeros_api/db/icp.py`, `services/api/buyeros_api/api/routes/{projects,icp}.py`, `services/api/buyeros_api/api/unimplemented.py`, `services/api/tests/{test_api_buyers,test_api_routes_contract}.py`, `services/live/client.ts`, `tests/live-adapter-checks.mjs`, `features/workspace.tsx`; docs under `docs/buyeros/**` |
